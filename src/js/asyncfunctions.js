...
async function getWeather(locationInput) {
  ...
  const fetchData = await fetch(`http://api.openweathermap.org/data/2.5/onecall?lat=${locationData[0].lat}&lon=${locationData[0].lon}&appid=${apiKey}&units=metric`, { mode: 'cors' })
